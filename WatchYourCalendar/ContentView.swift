        ...
        VStack {
            ...
            HStack {
                VStack {
                    ...
                    Toggle(isOn: $firstLunch[0]) { Text("Day 2") }.padding(.horizontal, 35.0)
                    Toggle(isOn: $firstLunch[0]) { Text("Day 3") }.padding(.horizontal, 35.0)
                    Toggle(isOn: $firstLunch[0]) { Text("Day 4") }.padding(.horizontal, 35.0)
                }
                VStack {
                    Toggle(isOn: $firstLunch[0]) { Text("Day 5") }.padding(.horizontal, 35.0)
                    Toggle(isOn: $firstLunch[0]) { Text("Day 6") }.padding(.horizontal, 35.0)
                    Toggle(isOn: $firstLunch[0]) { Text("Day 7") }.padding(.horizontal, 35.0)
                    Toggle(isOn: $firstLunch[0]) { Text("Day 8") }.padding(.horizontal, 35.0)
                }
            }
