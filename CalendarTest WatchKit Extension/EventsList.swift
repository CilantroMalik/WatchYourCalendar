...
//FIXME: Arrays within arrays? array of days, array of blocks within those days, then array of events within those blocks >(rohan) unnecessarily arduous and not needed, we can just filter by block in MidView
